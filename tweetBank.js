...
function add (name, content) {
    data.push({ id: id++,img:"http://lorempixel.com/350/230/",name: name, content: content });
  }
  function list () {
  ...
  const getFakeTweet = function() {
    const awesome_adj = ['increible', 'emocionante', 'resplandeciente', 'gracioso', 'dulce', 'cool',  'sorprendente', 'impresionante'];
